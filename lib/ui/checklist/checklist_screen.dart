...
class ChecklistState extends State<ChecklistScreen> {
  ...
  void filterChecklistResult() async {
    ...
    var url = 'checklist_results?check_unfinish=Y&checklist_id=' +
        checklist_id +
        '&room_id=' +
        room_id;

    var res = await Network().getData(
        'checklist_results?check_unfinish=Y&checklist_id=' +
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (value) {
                          ...
                          if (value.isEmpty) {
                            ...
                            final suggestions = listRoom.where((room) {
        ...
        InkWell(
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: ((context) {
                  return ChecklistResultDetailScreen(
